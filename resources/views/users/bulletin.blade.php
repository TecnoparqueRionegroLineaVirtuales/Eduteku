...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    @include('components.nav-landing')
        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <h1 class="text-2xl font-medium title-font mb-4 text-gray-900">Boletines tecnologicos</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">A continuacion encontraras todos los boletines tecnologicos realizados por nuestros expertos de tecnoparque nodo rionegro.</p>
            </div>
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                ...
                <div class="w-full">
                    <h2 class="title-font font-medium text-lg text-gray-900">Tecnologías Emergentes para el tratamiendo del Coronavirus</h2>
                    <h3 class="text-gray-500 mb-3">Boletin biotecnologia</h3>
                    <p class="mb-4">Descripcion del boletin</p>
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                ...
                <div class="w-full">
                    <h2 class="title-font font-medium text-lg text-gray-900">Secador de invernadero solar, una solución eficiente para procesos agroindustriales</h2>
                    <h3 class="text-gray-500 mb-3">Autor: Daniel Ramirez ing industrial.</h3>
