                        ...
                        <div class="modal-wrapper-flex sm:flex sm:item-start">
                            ...
                            <div class="modal-content text-center mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="modal-text">
                                    <form action="{{ route('bootcampLanding.update', $bootcamps->id) }}" method="POST"
                                        ...
                                        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                                            <div class="-mx-3 md:flex mb-6">
                                                <div class="md:w-full px-3">
                                                    <label for="name"
                                                        class="uppercase tracking-wide text-black text-xs font-bold mb-2">Nombre:</label>
                                                    <input
                                                        class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                                                        id="name" type="text" name="name"
                                                        value="{{ $bootcamps->name }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                                            <div class="-mx-3 md:flex mb-6">
                                                <div class="md:w-full px-3">
                                                    <label for="description"
                                                        class="uppercase tracking-wide text-black text-xs font-bold mb-2">Descripción:</label>
                                        ...
                                        <div class="-mx-3 md:flex mb-6">
                                            <div class="md:w-full px-3">
                                                <label class="uppercase tracking-wide text-black text-xs font-bold mb-2"
                                                    for="file">Términos de referencia:</label>
                                                <input
                                                    class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                                        ...
                                        <div class="-mx-3 md:flex mb-6">
                                            <div class="md:w-full px-3">
                                                <label for="url_course"
                                                    class="uppercase tracking-wide text-black text-xs font-bold mb-2">URL
                                                    del curso:</label>
                                                <input
                                                    class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                                                    id="url_course" type="text" name="url_course"
                                                    value="{{ $bootcamps->url_course }}" required>
                                            </div>
                                        </div>
                                        <div class="-mx-3 md:flex mb-6">
                                            <div class="md:w-full px-3">
                                                <label class="uppercase tracking-wide text-black text-xs font-bold mb-2"
                                                    for="id_challenge_filter_category">Categoría:</label>
                                                <select
                                                    class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                                                    id="id_challenge_filter_category"
                                                    name="id_challenge_filter_category" required>
                                                    <option value="" disabled selected>Selecciona una categoría
                                                    </option>
                                                    @foreach ($category as $categorys)
                                                        <option value="{{ $categorys->id }}"
                                                            {{ $bootcamps->id_challenge_filter_category == $categorys->id ? 'selected' : '' }}>
                                                            {{ $categorys->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="-mx-3 md:flex mb-6">
                                            ...
                                            <div class="md:w-full px-3">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <button type="button" id="addSponsor"
                                                        class="bg-green-500 text-white p-2 rounded ml-2">
                                                        <i class="fa fa-plus"></i> Agregar
                                                    </button>
                                                </div>
                                                <div id="sponsor-list"
                                                    class="mt-4 p-4 bg-gray-100 border border-gray-300 rounded">
                                                    <!-- Aquí se listarán los patrocinadores seleccionados -->
                                                    @foreach ($bootcamps->sponsors as $sponsor)
                                                        <div class="flex justify-between items-center mb-2">
                                                            <span>{{ $sponsor->name }}</span>
                                                            <button type="button"
                                                                class="removeSponsor bg-red-500 text-white p-1 rounded ml-2"
                                                                data-id="{{ $sponsor->id }}">
                                                                <i class="fa fa-trash"></i>
                                                            </button>
                                                            <input type="hidden" name="sponsors[]"
                                                                value="{{ $sponsor->id }}">
                                                        </div>
                                                    @endforeach
                                                </div>
