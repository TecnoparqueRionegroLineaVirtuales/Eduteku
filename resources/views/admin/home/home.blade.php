                                                ...
                                                @foreach ($multimedia as $multimedias)
                                                    <tr class="border-b border-neutral-200">
                                                        ...
                                                        <td class="whitespace-normal px-6 py-4 w-1/3">
                                                            <div
                                                                class="h-24 overflow-y-auto p-2 border border-gray-300 bg-gray-50 rounded">
                                                                {{ $multimedias->descripcion }}
                                                            </div>
                                                        </td>
                                                        <td class="whitespace-nowrap px-6 py-4"><img
                                                                src="{{ asset($multimedias->url) }}" alt="Imagen"
                                                                class="max-w-16 max-h-16"></td>
                                                        <td class="whitespace-nowrap px-6 py-4">
                                                            <form
                                                                action="{{ route('multimedia.destroy', $multimedias->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="hidden" name="type" value="home">
                                                                <button class="bg-red-400 text-white p-2 rounded"
                                                                    onclick="confirmarBorrado({{ $multimedias->id }})"><i
                                                                        class="fa fa-trash"></i></button>
                                                                <a href="{{ route('home.edit', $multimedias->id) }}"
                                    ...
                                    <div class="modal-wrapper bg-white px-4 pt-5 pb-4 sm:p-6 sm:pd-4">
                                        <div class="modal-wrapper-flex sm:flex sm:item-start">
                                            <div
                                                ...
                                                <i class="fa fa-home fa-2x fa-inverse"></i></div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="-mx-3 md:flex mb-6">
                                                                <div class="md:w-full px-3">
                                                                    ...
                                                                    <textarea class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" name="descripcion"
