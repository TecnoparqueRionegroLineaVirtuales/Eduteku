            ...
            <div id="main" class="main-content mt-12 md:mt-2 pb-24 md:pb-5">
                <div class="bg-gray-100 pt-3">
                    <div class="rounded-tl-3xl bg-gradient-to-r from-gray-100 to-green-500 p-4 shadow text-2xl text-current">
                        <h1 class="font-bold pl-2">EDT</h1>
                    </div>
                </div>
                @if (session('success'))
              ...
              @endif
                <div class="pt-10 py-10 px-10">
                    <button id="openModal" class="inline-flex items-center bg-green-500 border-0 py-1 px-3 focus:outline-none hover:bg-green-500 text-white rounded text-base mt-4 md:mt-0">Agregar EDT</button>
                </div>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="border-b border-neutral-200">
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4">
                                            <iframe class="absolute inset-0 w-26 h-10 object-cover object-center" src="https://www.youtube.com/embed/{{ $multimedias->link }}" title="EDTS" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                        </td>
                                        <td class="whitespace-nowrap px-6 py-4">
